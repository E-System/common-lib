...
public class Ssl {
    ...
    public static SSLContext context(String sslType, com.eslibs.common.security.model.KeyStore keyStore)
        throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {
        return context(sslType, keyStore, true);
    }

    public static SSLContext context(String sslType, com.eslibs.common.security.model.KeyStore keyStore, boolean allTrust)
        throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {
