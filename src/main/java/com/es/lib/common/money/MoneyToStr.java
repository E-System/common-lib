 ...
 */
package com.es.lib.common.money;
...
public final class MoneyToStr {
    ...
    static {
        ...
        try (InputStream inputStream = MoneyToStr.class.getResourceAsStream("/com/es/lib/common/currlist.xml")) {
