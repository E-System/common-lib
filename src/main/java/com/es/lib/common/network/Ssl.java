...
public class Ssl {
    ...
    public static SSLContext context(com.es.lib.common.network.KeyStore keyStore)
        throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {
        return context(SSL_TYPE_DEFAULT, keyStore);
    }

    public static SSLContext context(String sslType, com.es.lib.common.network.KeyStore keyStore)
        throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException {
    ...
    private static java.security.KeyStore load(com.es.lib.common.network.KeyStore keyStore) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException {
