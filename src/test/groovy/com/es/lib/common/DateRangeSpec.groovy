...
class DateRangeSpec extends Specification {
    ...
    def "Interval generate with next day"() {
        ...
        DateRange.Interval.CURRENT_WEEK  | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().setDayOfWeek(Calendar.MONDAY).build()                    | DateBuilder.create(TimeZone.default).clearTime().setDayOfWeek(Calendar.SUNDAY).addDayOfMonth(1).build()
        DateRange.Interval.LAST_WEEK     | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().addWeekOfMonth(-1).setDayOfWeek(Calendar.MONDAY).build() | DateBuilder.create(TimeZone.default).clearTime().addWeekOfMonth(-1).setDayOfWeek(Calendar.SUNDAY).addDayOfMonth(1).build()
        DateRange.Interval.CURRENT_MONTH | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).build()                                 | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).addMonth(1).build()
        DateRange.Interval.LAST_MONTH    | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().addMonth(-1).setDayOfMonth(1).build()                    | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).build()
        DateRange.Interval.CURRENT_TRIAD | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).build()                                 | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).addMonth(3).build()
        DateRange.Interval.LAST_TRIAD    | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).addMonth(-3).build()                    | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).build()
        DateRange.Interval.CURRENT_YEAR  | TimeZone.default | DateBuilder.create(TimeZone.default).clearTime().setDayOfMonth(1).setMonth(0).build()                     | DateBuilder.create(TimeZone.default).clearTime().addDayOfMonth(1).build()
