...
class MessageBundleSpec extends Specification {
    ...
    def "MessageBundle values loaded by path should be correct"() {
        expect:
        MessageBundle bundle = new MessageBundle("com/es/lib/common/locale/codes.properties")
    ...
    def "MessageBundle default values should be correct"() {
        ...
        "Value 255"         | 255           | null
        "Value 256"         | 256           | null
        "Value string.code" | 'string.code' | null
    ...
    def "MessageBundle default values with locale, should be correct"() {
        ...
        "Value string.code"       | 'string.code' | null            | "ru_RU"
        ...
        "Value string.code en_US" | 'string.code' | null            | "en_US"
        ...
        "Value en.only"           | 'en.only'     | "Value default" | "en_US"
    }
