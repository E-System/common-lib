        ...
        def calendar = new VCalendar(
                ...
                [
                        VCalendar.Event.builder()
                                ...
                                .startDate(new VCalendar.EventDate(LocalDate.of(2024, 7, 11).atStartOfDay()))
                                .endDate(new VCalendar.EventDate(LocalDate.of(2024, 7, 12).atStartOfDay()))
                                .summary("GeshGo (Booked)").build(),
                        VCalendar.Event.builder()
                                .id(UUID.randomUUID().toString())
                                .startDate(new VCalendar.EventDate(LocalDate.of(2024, 8, 11).atStartOfDay()))
                                .endDate(new VCalendar.EventDate(LocalDate.of(2024, 8, 20).atStartOfDay()))
                                .summary("GeshGo (Booked)").build()
                ]
        )
        ...
        def calendar = new VCalendar(
                ...
                [
                        VCalendar.Event.builder()
                                ...
                                .startDate(new VCalendar.EventDate(LocalDateTime.now(), true))
                                .endDate(new VCalendar.EventDate(LocalDateTime.now().plusHours(5), true))
